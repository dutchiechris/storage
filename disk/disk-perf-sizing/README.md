...
In the disk list above, disk `sg1-1` had a max minute average of 40,100 IOPS and 750 MiB/s, while the p99 minute average was 33,200 IOPS (20% less) and 390 MiB/s (52% less). You can set Hyperdisk provisioned performance conservatively at the Max, or Max + buffer %, to reduce the chance of disk throttling. Alternatively, for cost savings, you can choose a lower value with the expectation that during peak periods the disk will be throttled. When a disk is throttled, requests experience higher latency.
